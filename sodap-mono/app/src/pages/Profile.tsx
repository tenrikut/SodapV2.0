...
import BnplTab from "@/components/profile/BnplTab";
...
const Profile: React.FC = () => {
  ...
  const getTabIcon = (tab: string) => {
    switch (tab) {
      ...
      case "rewards":
        return <Gift className="mr-2" size={16} />;
      default:
        return null;
    }
  };
          ...
          >
                ...
                <TabsTrigger
                  ...
                  className={`flex items-center ${
                    activeTab === tab
                      ? "bg-white shadow-sm"
                      : "hover:bg-gray-200"
                  } rounded-md transition-all duration-200 px-4 py-2`}
                >
                  {getTabIcon(tab)}
                  {tab === "info"
                    ? "Profile Info"
            ...
            <Card className="border-gray-200 shadow-sm">
              <CardContent className="p-6">
                ...
                <TabsContent value="bnpl" className="mt-0">
                  <BnplTab />
                </TabsContent>
